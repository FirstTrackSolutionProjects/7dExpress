        ...
        <>
            <div className='absolute inset-0 bg-[rgba(0,0,0,0.5)] z-50 flex justify-center items-center overflow-y-auto'>
                ...
                <p className='absolute top-5 right-6 cursor-pointer' onClick={()=>{setView(false)}}>X</p>
                    ...
                    <button onClick={handleApprove} className=" bg-blue-500 text-white mx-2 py-2 px-4 rounded-lg">
                        Approve
                    </button>
                    <button onClick={handleReject} className=" bg-red-500 text-white mx-2 py-2 px-6 rounded-lg">
                        Reject
                    </button>
                </div>
            </div>
