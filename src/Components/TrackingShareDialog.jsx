...
import { Dialog, DialogTitle, DialogContent, Box, IconButton, Button, Typography, Divider, Tooltip } from '@mui/material';
...
const TrackingShareDialog = ({ isOpen, onClose, trackingData, report }) => {
  ...
  const generateTrackingMessage = () => {
    ...
    let message = `*🚚 7D Express - Shipment Tracking Update 🚚*\n\n`;
