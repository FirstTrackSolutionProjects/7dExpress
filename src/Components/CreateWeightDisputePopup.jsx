          ...
          <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(80vh - 2rem)' }}>
            <form onSubmit={handleSubmit} className="flex flex-col space-y-6 py-8">
                <div className="flex flex-col items-center space-y-2">
                    ...
                    <button type='button' onClick={getBoxes} disabled={!formData?.ord_id} className="mx-2 px-5 py-1 border rounded-lg disabled:bg-gray-400 bg-blue-500 text-white">Get Order Details</button>
                </div>
                ...
                <button type="submit" disabled={!(formData?.ord_id && formData?.dispute_deduction) || submitting} className="w-full px-4 py-2 mt-4 rounded-lg disabled:bg-gray-400 text-white bg-blue-500 hover:bg-blue-700">
