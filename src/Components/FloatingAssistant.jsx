            ...
            {isOpen && (
                ...
                >
                    ...
                    <div className="bg-sky-950 text-white px-5 py-4 flex justify-between items-center shrink-0">
                        <div>
                            <p className="font-bold text-sm tracking-tight">7D Express Support</p>
                            <p className="text-[10px] text-white/80 font-medium text-blue-100">Online • Typical reply 5m</p>
                        </div>
