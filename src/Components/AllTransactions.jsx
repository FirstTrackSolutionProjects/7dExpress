...
const AllTransactions =  () => {
    ...
    const downloadExcelFromExport = async (filters) => {
      try {
        setDownloading(true)
        const payload = {
          startDate: convertToUTCISOString(new Date(filters.startDate).setHours(0,0,0,0)),
          endDate: convertToUTCISOString(new Date(filters.endDate).setHours(23,59,59,999)),
