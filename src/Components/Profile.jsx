  ...
  return (
    <div className=" w-full h-full flex flex-col items-center overflow-x-hidden">
      <div className='w-full h-full bg-white p-8 flex flex-col items-center'>
        ...
        <div className='shadow-xl border-2 relative p-6 max-w-[500px] bg-white rounded-2xl overflow-hidden space-y-8'>
      ...
      </div> {/* Changed from 'border-2' to 'shadow-xl border-2' for consistency with other forms, kept 'rounded-2xl' */}
    </div>
  )
}
