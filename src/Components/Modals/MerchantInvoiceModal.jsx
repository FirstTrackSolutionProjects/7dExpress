...
import getMerchantInvoiceService from '../../services/invoiceServices/getMerchantInvoice.service'
...
const MerchantInvoiceModal = ({ open, onClose, merchantId }) => {
  ...
  const filename = `Invoice-7DINV${merchantId}${year}${String(month).padStart(2,'0')}.pdf`
