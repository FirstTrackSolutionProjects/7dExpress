...
const Header = () => {
  ...
  return (
      ...
      <div className="bg-bg-header bg-cover px-3 md:px-2">
          <div className="text-[10px] md:text-xl flex justify-evenly h-14 lg:h-20 md:flex items-center space-x-3 font-bold">
            <img src="images/logo1.png" alt="" className='lg:w-[90px] lg:h-[65px]  w-[45px] h-[28px]'></img>
