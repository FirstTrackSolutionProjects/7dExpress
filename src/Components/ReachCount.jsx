    ...
    return(
        <div className="grid grid-cols-1 sm:grid-rows-2 lg:grid-cols-2 lg:grid-rows-1">
            <div className="flex py-2 md:py-4 items-center justify-evenly md:mb-8">
                    <div className="w-28 md:w-44 h-28 rounded-3xl bg-red-500 bg-opacity-40 shadow-md shadow-red-400 md:mx-2">
                    ...
                    <div className=" w-32 md:w-36 h-28 rounded-3xl bg-blue-500 bg-opacity-40 shadow-md shadow-blue-400 md:mx-2">
                    ...
                    <div className="w-28 md:w-44 h-28 rounded-3xl bg-green-500 bg-opacity-40 shadow-md shadow-green-400  md:mx-2">
                    ...
                    <div className=" w-32 md:w-36 h-28 rounded-3xl bg-yellow-500 bg-opacity-40 shadow-md shadow-yellow-400 md:mx-2">
                    <div className='justify-center items-center text-center p-2'>
